...
$_['text_feed']   = 'Карта сайта: <span class="help">Адрес карты сайта для раздела галерей</span>';
...
$_['entry_hook_layout']   		= 'Схема страницы ошибки: <span class="help">Необходимо для правильной работы SEO контроллера.</span>';
...
$_['text_success_updated'] 					= 'Модуль успешно обновлен до версии 1.3.';
