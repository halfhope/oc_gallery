...
class ControllerExtensionModuleGalleryModules extends Controller {
	...
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			...
			$this->response->redirect($this->url->link($this->_route . '/modules', 'user_token=' . $this->session->data['user_token'], 'SSL'));
		}
		...
		$data['breadcrumbs'][] = [
			...
			'href'      => $this->url->link($this->_route . '/modules', 'user_token=' . $this->session->data['user_token'], 'SSL')
		];
		...
		$data['action'] = $this->url->link($this->_route . '/modules', 'user_token=' . $this->session->data['user_token'], 'SSL');
		$data['cancel'] = $this->url->link($this->_route . '/modules', 'user_token=' . $this->session->data['user_token'], 'SSL');
